...
if (tasksFromStorage !== null) {
    if (tasksFromStorage.length !== 0) tasksFromStorage.forEach((task)=>{
        ...
        text.addEventListener("click", ()=>{
            if (text.style.textDecoration === "line-through") text.style.textDecoration = "none";
            else text.style.textDecoration = "line-through";
            taskObj.isDone = !taskObj.isDone;
            let currentIndex;
            tasks.forEach((task, index)=>{
                if (task.text === taskObj.text) currentIndex = index;
            });
