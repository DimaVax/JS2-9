...
})({"cuoml":[function(require,module,exports,__globalThis) {
...
module.bundle.HMR_BUNDLE_ID = "d7408fe7cfdee58c";
"use strict";
...
},{}],"lMvSF":[function(require,module,exports,__globalThis) {
...
if (contactsFromStorage !== null) {
    if (contactsFromStorage.length !== 0) contactsFromStorage.forEach((contact)=>{
        ...
        nameText.setAttribute("id", (0, _uuid.v4)());
        ...
        removeBtn.addEventListener("click", ()=>{
            ...
            contacts.forEach((contact)=>{
                ...
                if (contactName === nameText.textContent) {
                    (0, _lodashDefault.default).remove(contacts, (currentContact)=>currentContact === contact);
...
},{"lodash":"3qBDj","uuid":"j4KJi","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["cuoml","lMvSF"], "lMvSF", "parcelRequire94c2")

//# sourceMappingURL=task4.cfdee58c.js.map
